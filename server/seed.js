...
const PACKAGES = [
  {
    code: 'dong-hanh',
    name: 'Gói Đồng Hành',
    target: 'Người cao tuổi còn minh mẫn, sống một mình, cần hỗ trợ sinh hoạt nhẹ nhàng và có người bầu bạn.',
    ...
    shift_hours: 4, price_shift: 220000, price_hour: 55000, price_month: 6300000,
  ...
  },
  {
    ...
    shift_hours: 4, price_shift: 380000, price_hour: 95000, price_month: 11000000,
  ...
  },
  {
    ...
    shift_hours: 12, price_shift: 1300000, price_hour: 108000, price_month: 25000000,
    price_month_max: 40000000,
    price_note: 'Thuê bao 24/7: 25 - 30 triệu cho tháng đăng ký đầu tiên; 32 - 40 triệu từ tháng thứ hai.',
    sort_order: 3
  },
  {
    code: 'thu-thuat-le',
    ...
    shift_hours: 1, price_shift: 300000, price_hour: 300000, price_month: null,
    price_month_max: null,
    price_note: 'Chi phí dao động 150.000 - 600.000 đ mỗi lần tuỳ loại thủ thuật.',
    sort_order: 4
  }
];
